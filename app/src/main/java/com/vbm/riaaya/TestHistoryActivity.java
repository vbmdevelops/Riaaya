...
import com.vbm.riaaya.adapter.TestHistoryAdapter;
...
public class TestHistoryActivity extends Activity {
    ...
    private RecyclerView rec_testhistorylist;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.testhistory_activity);

        rec_testhistorylist=(RecyclerView)findViewById(R.id.rec_testhistorylist);
        rec_testhistorylist.setHasFixedSize(true);
        LinearLayoutManager layoutManager = new LinearLayoutManager(this, LinearLayoutManager.VERTICAL, true);
        layoutManager.setReverseLayout(false);
        rec_testhistorylist.setLayoutManager(new GridLayoutManager(this, 1));
        testHistoryData=new ArrayList<>();
        testHistoryAdapter=new TestHistoryAdapter(testHistoryData,this);
        int resId1 = R.anim.test;
        LayoutAnimationController animation1 = AnimationUtils.loadLayoutAnimation(this, resId1);
        rec_testhistorylist.setLayoutAnimation(animation1);
        ...
        try {
            ...
            Glide.with(TestHistoryActivity.this)
        ...
        if (AppController.getSpIsLogin().getBoolean(SPUtils.IS_LOGIN, false)) {
            ...
            lin_login.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    myDialog = new Dialog(TestHistoryActivity.this);
                    ...
                    Yes.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            Intent intent = new Intent(TestHistoryActivity.this, SplashScreen.class);
        ...
        else
        {
            ...
            lin_login.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(TestHistoryActivity.this,LoginActivity.class);
                    startActivity(intent);
                }
            });
        }
        ...
        fab_home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent1 = new Intent(TestHistoryActivity.this, MainActivity.class);
        ...
        lin_profile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (AppController.getSpIsLogin().getBoolean(SPUtils.IS_LOGIN, false)) {
                    Intent intent = new Intent(TestHistoryActivity.this,UserProfileActivity.class);
                    startActivity(intent);
                }
                else
                {
        ...
        lin_booktest.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(TestHistoryActivity.this,MedicalTest_Activity.class);
                startActivity(intent);
            }
        });
...
*/
        if(AppUtils.isNetworkAvailable(TestHistoryActivity.this))
        {
            displayLoader();
            BookedTestList();
        ...
        {
            Toasty.warning(TestHistoryActivity.this,getResources().getString(R.string.nointernet), Toast.LENGTH_LONG).show();
    ...
    private void BookedTestList() {
        String URL = "https://demo.innodasolutions.com/riaaya/API/riaaya_user/userBookList.php?case=bookHistory&token="+AppController.getSpUserInfo().getString(SPUtils.USER_TOKEN,"");
        Log.e("URL",URL);
                ...
                try {
                    ...
                    if (jsonObject.getString("statusCode").equalsIgnoreCase("S")) {
                        ...
                        for (int i = 0; i < jarr.length(); i++) {
                            ...
                            {
                                TestHistoryData ld = new TestHistoryData(ob.getString("booking_no"),ob.getString("p_name"),ob.getString("id"),ob.getString("test_arb"),ob.getString("book_date"),ob.getString("status"),
                                ...
                                testHistoryData.add(ld);
                            }
                            else
                            {
                                TestHistoryData ld = new TestHistoryData(ob.getString("booking_no"),ob.getString("p_name"),ob.getString("id"),ob.getString("test_name"),ob.getString("book_date"),ob.getString("status"),
                        ...
                        rec_testhistorylist.setAdapter(testHistoryAdapter);
                    }
                    else
                    {
                       /* lin_1.setVisibility(View.GONE);
                        ...
                        Toasty.warning(TestHistoryActivity.this,getResources().getString(R.string.nodata), Toast.LENGTH_LONG).show();
                    }

                } catch (JSONException e) {
                    e.printStackTrace();
                    dialog.dismiss();
                    Toasty.warning(TestHistoryActivity.this,e.getMessage(), Toast.LENGTH_LONG).show();
                  /*  lin_1.setVisibility(View.GONE);
                    lin_nointernet.setVisibility(View.GONE);
                    lin_nodata.setVisibility(View.GONE);
    ...
    private void displayLoader() {
        dialog = new Dialog(TestHistoryActivity.this);
