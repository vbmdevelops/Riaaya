...
public class HosptialFilter extends Filter {
    TestHosptialAdapter TestHosptialAdapter;
    ArrayList<Hosptial_Data> jobData;


    public HosptialFilter(ArrayList<Hosptial_Data> filterList, TestHosptialAdapter adapter)
    {
