...
public class AllHosptialListActivity extends Activity {
    ...
    private AllHosptialListAdapter hosptialAdapter;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        hosptialAdapter=new AllHosptialListAdapter(hosptial_Data,this);
        ...
        try {
            ...
            Glide.with(AllHosptialListActivity.this)
        ...
        if (AppController.getSpIsLogin().getBoolean(SPUtils.IS_LOGIN, false)) {
            ...
            lin_login.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    myDialog = new Dialog(AllHosptialListActivity.this);
                    ...
                    Yes.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            Intent intent = new Intent(AllHosptialListActivity.this, SplashScreen.class);
        ...
        else
        {
            ...
            lin_login.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(AllHosptialListActivity.this,LoginActivity.class);
                    startActivity(intent);
                }
            });
        }
        ...
        fab_home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent1 = new Intent(AllHosptialListActivity.this, MainActivity.class);
        ...
        lin_profile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (AppController.getSpIsLogin().getBoolean(SPUtils.IS_LOGIN, false)) {
                    Intent intent = new Intent(AllHosptialListActivity.this,UserProfileActivity.class);
                    startActivity(intent);
                }
                else
                {
        ...
        lin_booktest.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(AllHosptialListActivity.this,MedicalTest_Activity.class);
                startActivity(intent);
            }
        });
        ...
        if(AppUtils.isNetworkAvailable(AllHosptialListActivity.this))
        {
            displayLoader();
            MedicalTestList();
        ...
        {
            Toasty.warning(AllHosptialListActivity.this,getResources().getString(R.string.nointernet), Toast.LENGTH_LONG).show();
                ...
                protected String doInBackground(Void... params) {
                    ...
                    try {
                     ...
                     /*   postParameters.add(new BasicNameValuePair("SearchByDoctorName_Speciality",""));
                        ...
                        response = AppUtils.callWebServiceWithMultiParam(AllHosptialListActivity.this,postParameters, "userhospital.php", "TAG");
                ...
                protected void onPostExecute(String resultData) {
                    try {
                        ...
                        if (jsonObject.getString("statusCode").equalsIgnoreCase("S")) {
                            ...
                            Toasty.warning(AllHosptialListActivity.this,getResources().getString(R.string.nodata), Toast.LENGTH_LONG).show();
                        ...
                        e.printStackTrace();
                        Toasty.warning(AllHosptialListActivity.this,getResources().getString(R.string.server), Toast.LENGTH_LONG).show();
                       /* lin_1.setVisibility(View.GONE);
                        lin_nointernet.setVisibility(View.GONE);
                        lin_nodata.setVisibility(View.GONE);
   ...
   /* private void MedicalTestList() {
        String URL = "http://demo.innodasolutions.com/riaaya/API/riaaya_user/userlab.php?hospital_id=3&status=A";
        Log.e("URL",URL);
        StringRequest stringRequest=new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    {
                        Toasty.warning(AppHosptialListActivity.this,jsonObject.getString("statusCode"), Toast.LENGTH_LONG).show();
                    ...
                    e.printStackTrace();
                    dialog.dismiss();
                    // Toasty.warning(MainActivity.this,"Internal server error",Toast.LENGTH_LONG).show();
                }
    ...
    private void displayLoader() {
        dialog = new Dialog(AllHosptialListActivity.this);
